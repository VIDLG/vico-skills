...
class VicoAutomationTests(unittest.TestCase):
    ...
    def test_readme_expresses_grounding_and_execution_model(self) -> None:
        ...
        self.assertIn("default to forward design; do not assume historical burden", readme)
    ...
    def test_ground_skill_has_shared_ground_model_and_moves(self) -> None:
        ...
        self.assertIn("## Forward-Only Design Discipline", ground_skill)
        self.assertIn("Default to forward design and assume no historical burden unless the user explicitly says compatibility matters.", ground_skill)
        ...
        self.assertIn("Confidence: medium", ground_output)
        self.assertIn("Uncertainty source:", ground_output)
        self.assertIn("Scope impact:", ground_output)
        ...
        self.assertIn("Recommended next action", ground_output)
        self.assertIn("Risk if skipped", ground_output)
        self.assertIn("Alternative next actions", ground_output)
    ...
    def test_exec_skill_has_cc_mode_runner_and_disciplines(self) -> None:
        ...
        self.assertIn("Scope impact: local | active_slug | cross_slug | repo_wide", plan_review)
        ...
        self.assertIn("Scope impact: local | active_slug | cross_slug | repo_wide", plan_verify)
        ...
        self.assertIn("Scope impact: local | active_slug | cross_slug | repo_wide", exec_report)
