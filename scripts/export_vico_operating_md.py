...
def build_markdown(
    ...
    lines = [
        ...
        "- Use `vico-plan` to create, verify, or reshape tracked work under `.vico/`.",
        "- Use `vico-exec` for persistent execution against an active plan.",
        "- Use `vico-ops` for repo-local bootstrap, sync, close-out, truth extraction, or workspace validation.",
