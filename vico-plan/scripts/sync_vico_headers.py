...
from vico_common import active_slugs, repo_root_from_arg, sync_active_headers_for_slug, today_iso


def main() -> int:
    parser = argparse.ArgumentParser(description="Synchronize Vico plan/PRD headers with current slug, cross-links, and manifest paths.")
