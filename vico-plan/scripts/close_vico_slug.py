...
def main() -> int:
    parser = argparse.ArgumentParser(description="Delete active Vico docs for a closed slug and clear temporary state.")
    parser.add_argument("slug", help="Slug to close and delete from active Vico docs.")
