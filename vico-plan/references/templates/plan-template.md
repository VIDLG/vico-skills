...
Use this template for `.vico/plans/active/<slug>.md`.
...
A plan is `vico-exec` ready only when the next slice can be chosen without guessing, acceptance criteria are observable, and focused verification is named.
